...
class GhostAdvancedStrategy(IStrategy):
    ...
    # 参数（hyperopt优化结果）
    buy_rsi = IntParameter(65, 85, default=73, space='buy', optimize=False)
    buy_bb_pos = DecimalParameter(0.90, 1.0, default=0.998, space='buy', optimize=False)
    sell_tp = DecimalParameter(0.05, 0.20, default=0.102, space='sell', optimize=False)
    max_hold = IntParameter(20, 100, default=44, space='sell', optimize=False)
